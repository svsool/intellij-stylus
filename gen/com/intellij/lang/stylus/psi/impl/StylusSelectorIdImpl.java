...
public class StylusSelectorIdImpl extends ASTWrapperPsiElement implements StylusSelectorId {

  public StylusSelectorIdImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof StylusVisitor) ((StylusVisitor)visitor).visitSelectorId(this);
